...
// --- August 2025 ---
  ...
  { date: '2025-11-08', cycleDay: 23, cyclePhase: CyclePhase.LUTEAL, suggestion: '控糖、轻断食', predictedWeight: 54.1, predictedBodyFat: 28.4, actualWeight: 54.7, actualBodyFat: 28.6, note: '壁球，打拳', completedWorkout: true },
  ...
  { date: '2025-11-20', cycleDay: 9, cyclePhase: CyclePhase.FOLLICULAR, suggestion: '控糖 + 轻有氧', predictedWeight: 53.7, predictedBodyFat: 28.1, actualWeight: 53.7, actualBodyFat: 28.2, note: '普拉提', completedWorkout: true },
